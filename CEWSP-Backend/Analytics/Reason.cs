...
namespace CEWSP_Backend.Analytics
{
    ...
    public enum EReason
    {
        ...
        /// <summary>
        /// The provided editor exe path is not the Sandbox editor exe
        /// (checked via FileVersionInfo.ProductName)
        /// </summary>
        eR_CEEditorPathIsNotEditorExe
    }
    ...
    public class Reason
    {
        ...
        /// ID of this reason
        /// </summary>
        private int m_nReasonID;

        /// <summary>
        /// Has the ID been set already
        /// </summary>
        private bool m_bIsIDSet;
